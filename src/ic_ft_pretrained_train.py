...
model_checkpoint = "./models/ft_pretrained_test2" # path of the model checkpoint to load (only used if the previous line is True)
save_model_to = f"./models/ft_pretrained_{get_current_time_string()}" # path where to save the fine-tuned model
